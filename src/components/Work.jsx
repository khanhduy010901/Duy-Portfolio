      ...
      <div className='flex flex-col lg:flex-row gap-x-20'>
        <motion.div 
          ...
          <div>
            ...
            <p className='max-w-sm mb-16'>
              Some of the projects I've done hope to help you.
              Some of the projects I've done hope to help you.
              Some of the projects I've done hope to help you.
            </p>
        ...
        <motion.div
          ...
          <div className='group relative overflow-hidden border-2
              ...
              />
              <div className='absolute -bottom-full left-12
              group-hover:bottom-24 transition-all duration-500 z-20'>
                <span className='text-gradient'>
                  UX/UI Design
                </span>
              </div>
              <div className='absolute -bottom-full left-12
              group-hover:bottom-14 transition-all duration-700 z-20'>
                <span className='text-3xl text-white'>Project Title</span>
              </div>
          </div>
